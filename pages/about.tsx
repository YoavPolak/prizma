export default function about() {
    return (
        <div className="container-about t1">
            <div className="txt-container" dir="rtl">
                <h1 dir="rtl" className="about font-semibold font-sans text-3xl">אודותינו</h1>
                <p dir="rtl" >
            ...
            <div>
                <h1  dir="rtl" className="our-team font-semibold font-sans text-3xl">הצוות שלנו</h1>
